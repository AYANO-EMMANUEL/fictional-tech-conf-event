...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <header className="bg-gradient-to-r py- text-center from-green-500 to-green-700 bg-cover bg-bottom bg-[url('../src/assets/tnigeria-bg.jpeg')] text-white shadow-lg">
      ...
      {activeSection === 'register' && (
        <section className="py-12 md:py-20 bg-gradient-to-b from-nigeria-greenLight to-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Three days of innovation, tech leadership, and networking with Africa's brightest tech minds. Featuring local and international speakers.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <h3 className="text-xl font-bold">NaijaTech Summit 2025</h3>
              <p className="text-gray-400">Empowering Africa's digital transformation</p>
            </div>
